...
(function() {
  var Range, applyToShareJS, rangeToCursor;
  ...
  applyToShareJS = function(editorDoc, delta, doc) {
    ...
    getStartOffsetPosition = function(range) {
      return rangeToPosition(editorDoc, range);
    };
  ...
  window.sharejs.extendDoc('attach_ace', function(editor, keepEditorContents) {
    ...
    updateCursors = function() {
      return console.log("updating cursors", this.cursors);
    };
    ...
    cursorListener = function(change) {
      ...
      return doc.setCursor(rangeToPosition(currentSelection));
    };
    editorDoc.on('change', editorListener);
    editorDoc.on("changeSelection", cursorListener);
